function [Radiosonde] = compute_mlh_parcel_standard(Radiosonde,SurfaceData)
...
% use virtual potential temperature instead of potential temperature.
...
Radiosonde.mlhParcelStandard = Radiosonde.height(ind);

% Store the time of the MLH in decimal hours since midnight [hours]
Radiosonde.mlhParcelStandardTime = Radiosonde.launchTimeUtc + ...
